      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5">
        ...
        <ul className="flex flex-col gap-2">
          {taskTypes.map((taskType) => (
            <li key={taskType.id} className="flex items-center justify-between rounded-lg px-3 py-2 text-sm text-white" style={{ backgroundColor: taskType.color }}>
